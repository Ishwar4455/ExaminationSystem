<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateBatchData.aspx.cs" Inherits="ExaminationSystem.UpdateBatchData" %>
    ...
    <div class="row">
        <div class=" col-md-12">
            <div class="form-group">
                <asp:DropDownList ID="ddl_Batch" Style="text-align: center;" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddl_Batch_SelectedIndexChanged" AutoPostBack="True">
                </asp:DropDownList>
            </div>
            <div class="form-group">
